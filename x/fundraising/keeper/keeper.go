...
func NewKeeper(
	...
	k := Keeper{
		...
		MatchedBidsLen: collections.NewMap(sb, types.MatchedBidsLenKey, "matched_bids_len", collections.Uint64Key, collections.Int64Value),
		AllowedBidder:  collections.NewMap(sb, types.AllowedBidderKey, "allowed_bidder", collections.PairKeyCodec(collections.Uint64Key, sdk.LengthPrefixedAddressKey(sdk.AccAddressKey)), codec.CollValue[types.AllowedBidder](cdc)),
		VestingQueue:   collections.NewMap(sb, types.VestingQueueKey, "vesting_queue", collections.PairKeyCodec(collections.Uint64Key, sdk.TimeKey), codec.CollValue[types.VestingQueue](cdc)),
