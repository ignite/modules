...
func (s *KeeperTestSuite) TestBatchAuction_Many() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("500_000_000denom1"), math.NewInt(1_000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(2), parseDec("0.9"), parseCoin("500_000_000denom1"), math.NewInt(1_000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("500_000_000denom1"), math.NewInt(1_000_000_000), true)
...
func (s *KeeperTestSuite) TestBatchAuction_Worth() {
	...
	s.placeBidBatchWorth(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("500_000_000denom2"), math.NewInt(1500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("0.9"), parseCoin("500_000_000denom2"), math.NewInt(1500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("500_000_000denom2"), math.NewInt(1500_000_000), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("500_000_000denom1"), math.NewInt(1500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("0.9"), parseCoin("500_000_000denom2"), math.NewInt(1500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("500_000_000denom2"), math.NewInt(1500_000_000), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Many_Limited() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("400_000_000denom1"), math.NewInt(400_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(2), parseDec("0.9"), parseCoin("400_000_000denom1"), math.NewInt(400_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("400_000_000denom1"), math.NewInt(400_000_000), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Worth_Limited() {
	...
	s.placeBidBatchWorth(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("400_000_000denom2"), math.NewInt(400_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("0.9"), parseCoin("360_000_000denom2"), math.NewInt(400_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("320_000_000denom2"), math.NewInt(400_000_000), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed_Limited() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("500_000_000denom1"), math.NewInt(600_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("0.9"), parseCoin("500_000_000denom2"), math.NewInt(600_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("450_000_000denom2"), math.NewInt(600_000_000), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed2() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("200_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("0.8"), parseCoin("500_000_000denom2"), math.NewInt(5000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(3), parseDec("0.9"), parseCoin("500_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(1), parseDec("1.1"), parseCoin("300_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(5), parseDec("1.2"), parseCoin("300_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(4), parseDec("0.8"), parseCoin("100_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(2), parseDec("0.7"), parseCoin("100_000_000denom1"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(6), parseDec("0.5"), parseCoin("100_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("300_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(7), parseDec("0.6"), parseCoin("500_000_000denom2"), math.NewInt(5000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(8), parseDec("0.8"), parseCoin("500_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(9), parseDec("0.6"), parseCoin("600_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(6), parseDec("0.5"), parseCoin("500_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(10), parseDec("0.6"), parseCoin("100_000_000denom1"), math.NewInt(5000_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.7"), parseCoin("800_000_000denom2"), math.NewInt(0), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed2_LimitedSame() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("200_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("0.8"), parseCoin("500_000_000denom2"), math.NewInt(700_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(3), parseDec("0.9"), parseCoin("500_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(1), parseDec("1.1"), parseCoin("300_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(5), parseDec("1.2"), parseCoin("300_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(4), parseDec("0.8"), parseCoin("100_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(2), parseDec("0.7"), parseCoin("100_000_000denom1"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(6), parseDec("0.5"), parseCoin("100_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("300_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(7), parseDec("0.6"), parseCoin("400_000_000denom2"), math.NewInt(700_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(8), parseDec("0.8"), parseCoin("500_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(9), parseDec("0.6"), parseCoin("600_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(6), parseDec("0.5"), parseCoin("350_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(10), parseDec("0.6"), parseCoin("100_000_000denom1"), math.NewInt(700_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.7"), parseCoin("490_000_000denom2"), math.NewInt(0), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed2_LimitedDifferent() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("1"), parseCoin("200_000_000denom1"), math.NewInt(1000_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("0.8"), parseCoin("500_000_000denom2"), math.NewInt(1000_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(3), parseDec("0.9"), parseCoin("500_000_000denom1"), math.NewInt(800_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(1), parseDec("1.1"), parseCoin("300_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(5), parseDec("1.2"), parseCoin("300_000_000denom1"), math.NewInt(600_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(4), parseDec("0.8"), parseCoin("100_000_000denom1"), math.NewInt(800_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(2), parseDec("0.7"), parseCoin("100_000_000denom1"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(6), parseDec("0.5"), parseCoin("100_000_000denom1"), math.NewInt(600_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.8"), parseCoin("300_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(7), parseDec("0.6"), parseCoin("200_000_000denom2"), math.NewInt(400_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(8), parseDec("0.8"), parseCoin("400_000_000denom1"), math.NewInt(400_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(9), parseDec("0.6"), parseCoin("200_000_000denom1"), math.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(6), parseDec("0.5"), parseCoin("300_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(10), parseDec("0.6"), parseCoin("100_000_000denom1"), math.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(3), parseDec("0.7"), parseCoin("560_000_000denom2"), math.NewInt(0), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed3() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("10"), parseCoin("200_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("11"), parseCoin("2000_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(3), parseDec("10.5"), parseCoin("500_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(4), parseDec("10.2"), parseCoin("1500_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(5), parseDec("10.8"), parseCoin("300_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(6), parseDec("11.4"), parseCoin("2500_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(7), parseDec("11.3"), parseCoin("100_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(8), parseDec("9.9"), parseCoin("2500_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(9), parseDec("10.1"), parseCoin("300_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(10), parseDec("10.45"), parseCoin("2000_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(11), parseDec("10.75"), parseCoin("150_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(12), parseDec("10.99"), parseCoin("1500_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(13), parseDec("10.2"), parseCoin("200_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(14), parseDec("9.87"), parseCoin("2000_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(15), parseDec("10.25"), parseCoin("200_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(16), parseDec("10.48"), parseCoin("2500_000_000denom2"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(17), parseDec("10.52"), parseCoin("180_000_000denom1"), math.NewInt(2500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(4), parseDec("10.8"), parseCoin("220_000_000denom1"), math.NewInt(0), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(5), parseDec("10.5"), parseCoin("1500_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(6), parseDec("9.7"), parseCoin("250_000_000denom1"), math.NewInt(0), true)
...
func (s *KeeperTestSuite) TestCalculateAllocation_Mixed3_LimitedDifferent() {
	...
	s.placeBidBatchMany(auction.AuctionId, s.addr(1), parseDec("10"), parseCoin("200_000_000denom1"), math.NewInt(500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(2), parseDec("11"), parseCoin("2000_000_000denom2"), math.NewInt(500_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(3), parseDec("10.5"), parseCoin("500_000_000denom1"), math.NewInt(500_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(4), parseDec("10.2"), parseCoin("1500_000_000denom2"), math.NewInt(200_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(5), parseDec("10.8"), parseCoin("200_000_000denom1"), math.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(6), parseDec("11.4"), parseCoin("2200_000_000denom2"), math.NewInt(200_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(7), parseDec("11.3"), parseCoin("100_000_000denom1"), math.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(8), parseDec("9.9"), parseCoin("1900_000_000denom2"), math.NewInt(200_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(9), parseDec("10.1"), parseCoin("200_000_000denom1"), math.NewInt(200_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(10), parseDec("10.45"), parseCoin("2000_000_000denom2"), math.NewInt(200_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(11), parseDec("10.75"), parseCoin("100_000_000denom1"), math.NewInt(100_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(12), parseDec("10.99"), parseCoin("1050_000_000denom2"), math.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(13), parseDec("10.2"), parseCoin("100_000_000denom1"), math.NewInt(100_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(14), parseDec("9.87"), parseCoin("980_000_000denom2"), math.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(15), parseDec("10.25"), parseCoin("100_000_000denom1"), math.NewInt(100_000_000), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(16), parseDec("10.48"), parseCoin("1000_000_000denom2"), math.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(17), parseDec("10.52"), parseCoin("100_000_000denom1"), math.NewInt(100_000_000), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(4), parseDec("10.8"), parseCoin("200_000_000denom1"), math.NewInt(0), true)
	s.placeBidBatchWorth(auction.AuctionId, s.addr(5), parseDec("10.5"), parseCoin("1500_000_000denom2"), math.NewInt(0), true)
	s.placeBidBatchMany(auction.AuctionId, s.addr(6), parseDec("9.7"), parseCoin("200_000_000denom1"), math.NewInt(0), true)
