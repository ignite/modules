...
type QueryAllAllowedBidderResponse struct {
	AllowedBidder []AllowedBidder `protobuf:"bytes,1,rep,name=allowedBidder,proto3" json:"allowedBidder"`
	// pagination defines the pagination in the response
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
type QueryGetAllowedBidderResponse struct {
	AllowedBidder AllowedBidder `protobuf:"bytes,1,opt,name=allowedBidder,proto3" json:"allowedBidder"`
}
...
var fileDescriptor_9275eda8d24f0a10 = []byte{
	...
	,
}
