...
var fileDescriptor_7e359d03a10c572a = []byte{
	...
	,
	...
	0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xe3, 0xf0, 0x7a, 0x49, 0x65, 0x41, 0x6a, 0x71,
	0x12, 0x1b, 0xd8, 0x2a, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xf5, 0x20, 0xbd, 0x1f, 0x0b,
	0x02, 0x00, 0x00,
}
...
func (m *DecayInformation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n2, err2 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.DecayEnd, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.DecayEnd):])
	if err2 != nil {
		return 0, err2
	}
	i -= n2
	...
	i--
	dAtA[i] = 0x1a
	n3, err3 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.DecayStart, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.DecayStart):])
	if err3 != nil {
		return 0, err3
	}
	i -= n3
