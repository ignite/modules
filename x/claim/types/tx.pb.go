...
func init() {
	proto.RegisterType((*MsgClaim)(nil), "modules.claim.MsgClaim")
	proto.RegisterType((*MsgClaimResponse)(nil), "modules.claim.MsgClaimResponse")
}
...
func (c *msgClient) Claim(ctx context.Context, in *MsgClaim, opts ...grpc.CallOption) (*MsgClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/modules.claim.Msg/Claim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Claim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modules.claim.Msg/Claim",
	}
