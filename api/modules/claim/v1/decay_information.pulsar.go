...
var (
	...
	fd_DecayInformation_decay_start protoreflect.FieldDescriptor
	fd_DecayInformation_decay_end   protoreflect.FieldDescriptor
)

func init() {
	file_modules_claim_v1_decay_information_proto_init()
	md_DecayInformation = File_modules_claim_v1_decay_information_proto.Messages().ByName("DecayInformation")
	fd_DecayInformation_enabled = md_DecayInformation.Fields().ByName("enabled")
	fd_DecayInformation_decay_start = md_DecayInformation.Fields().ByName("decay_start")
	fd_DecayInformation_decay_end = md_DecayInformation.Fields().ByName("decay_end")
}
...
func (x *DecayInformation) slowProtoReflect() protoreflect.Message {
	mi := &file_modules_claim_v1_decay_information_proto_msgTypes[0]
...
func (x *fastReflection_DecayInformation) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.DecayStart != nil {
		...
		if !f(fd_DecayInformation_decay_start, value) {
			return
		}
	}
	if x.DecayEnd != nil {
		value := protoreflect.ValueOfMessage(x.DecayEnd.ProtoReflect())
		if !f(fd_DecayInformation_decay_end, value) {
			return
		}
	}
}
...
func (x *fastReflection_DecayInformation) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "modules.claim.v1.DecayInformation.enabled":
		return x.Enabled != false
	case "modules.claim.v1.DecayInformation.decay_start":
		return x.DecayStart != nil
	case "modules.claim.v1.DecayInformation.decay_end":
		return x.DecayEnd != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.claim.v1.DecayInformation"))
		}
		panic(fmt.Errorf("message modules.claim.v1.DecayInformation does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DecayInformation) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message modules.claim.v1.DecayInformation does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DecayInformation) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "modules.claim.v1.DecayInformation.enabled":
		panic(fmt.Errorf("field enabled of message modules.claim.v1.DecayInformation is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.claim.v1.DecayInformation"))
		}
...
func (x *fastReflection_DecayInformation) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in modules.claim.v1.DecayInformation", d.FullName()))
	}
	panic("unreachable")
}
...
type DecayInformation struct {
	...
	DecayStart *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=decay_start,json=decayStart,proto3" json:"decay_start,omitempty"`
	DecayEnd   *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=decay_end,json=decayEnd,proto3" json:"decay_end,omitempty"`
}
...
func (*DecayInformation) Descriptor() ([]byte, []int) {
	return file_modules_claim_v1_decay_information_proto_rawDescGZIP(), []int{0}
}
...
var File_modules_claim_v1_decay_information_proto protoreflect.FileDescriptor

var file_modules_claim_v1_decay_information_proto_rawDesc = []byte{
	0x0a, 0x28, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2f, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x2f,
	0x76, 0x31, 0x2f, 0x64, 0x65, 0x63, 0x61, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x6d, 0x6f, 0x64, 0x75,
	0x6c, 0x65, 0x73, 0x2e, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x2e, 0x76, 0x31, 0x1a, 0x11, 0x61, 0x6d,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb6, 0x01, 0x0a, 0x10, 0x44, 0x65, 0x63, 0x61, 0x79,
	0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x65,
	0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x65, 0x6e,
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x45, 0x0a, 0x0b, 0x64, 0x65, 0x63, 0x61, 0x79, 0x5f, 0x73,
	...
	,
...
var (
	file_modules_claim_v1_decay_information_proto_rawDescOnce sync.Once
	file_modules_claim_v1_decay_information_proto_rawDescData = file_modules_claim_v1_decay_information_proto_rawDesc
)

func file_modules_claim_v1_decay_information_proto_rawDescGZIP() []byte {
	file_modules_claim_v1_decay_information_proto_rawDescOnce.Do(func() {
		file_modules_claim_v1_decay_information_proto_rawDescData = protoimpl.X.CompressGZIP(file_modules_claim_v1_decay_information_proto_rawDescData)
	})
...
var file_modules_claim_v1_decay_information_proto_depIdxs = []int32{
	1, // 0: modules.claim.v1.DecayInformation.decay_start:type_name -> google.protobuf.Timestamp
	1, // 1: modules.claim.v1.DecayInformation.decay_end:type_name -> google.protobuf.Timestamp
...
func init() { file_modules_claim_v1_decay_information_proto_init() }
func file_modules_claim_v1_decay_information_proto_init() {
	if File_modules_claim_v1_decay_information_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_modules_claim_v1_decay_information_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_modules_claim_v1_decay_information_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_modules_claim_v1_decay_information_proto_goTypes,
		DependencyIndexes: file_modules_claim_v1_decay_information_proto_depIdxs,
		MessageInfos:      file_modules_claim_v1_decay_information_proto_msgTypes,
	}.Build()
	File_modules_claim_v1_decay_information_proto = out.File
	file_modules_claim_v1_decay_information_proto_rawDesc = nil
	file_modules_claim_v1_decay_information_proto_goTypes = nil
	file_modules_claim_v1_decay_information_proto_depIdxs = nil
}
