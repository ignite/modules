...
var (
	...
	fd_InitialClaim_mission_id protoreflect.FieldDescriptor
)

func init() {
	file_modules_claim_v1_initial_claim_proto_init()
	md_InitialClaim = File_modules_claim_v1_initial_claim_proto.Messages().ByName("InitialClaim")
	fd_InitialClaim_enabled = md_InitialClaim.Fields().ByName("enabled")
	fd_InitialClaim_mission_id = md_InitialClaim.Fields().ByName("mission_id")
}
...
func (x *InitialClaim) slowProtoReflect() protoreflect.Message {
	mi := &file_modules_claim_v1_initial_claim_proto_msgTypes[0]
...
func (x *fastReflection_InitialClaim) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MissionId != uint64(0) {
		...
		if !f(fd_InitialClaim_mission_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_InitialClaim) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "modules.claim.v1.InitialClaim.enabled":
		return x.Enabled != false
	case "modules.claim.v1.InitialClaim.mission_id":
		return x.MissionId != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.claim.v1.InitialClaim"))
		}
		panic(fmt.Errorf("message modules.claim.v1.InitialClaim does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_InitialClaim) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message modules.claim.v1.InitialClaim does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_InitialClaim) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "modules.claim.v1.InitialClaim.enabled":
		panic(fmt.Errorf("field enabled of message modules.claim.v1.InitialClaim is not mutable"))
	case "modules.claim.v1.InitialClaim.mission_id":
		panic(fmt.Errorf("field mission_id of message modules.claim.v1.InitialClaim is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.claim.v1.InitialClaim"))
		}
...
func (x *fastReflection_InitialClaim) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in modules.claim.v1.InitialClaim", d.FullName()))
	}
	panic("unreachable")
}
...
func (*InitialClaim) Descriptor() ([]byte, []int) {
	return file_modules_claim_v1_initial_claim_proto_rawDescGZIP(), []int{0}
}
...
var File_modules_claim_v1_initial_claim_proto protoreflect.FileDescriptor

var file_modules_claim_v1_initial_claim_proto_rawDesc = []byte{
	,
...
var (
	file_modules_claim_v1_initial_claim_proto_rawDescOnce sync.Once
	file_modules_claim_v1_initial_claim_proto_rawDescData = file_modules_claim_v1_initial_claim_proto_rawDesc
)

func file_modules_claim_v1_initial_claim_proto_rawDescGZIP() []byte {
	file_modules_claim_v1_initial_claim_proto_rawDescOnce.Do(func() {
		file_modules_claim_v1_initial_claim_proto_rawDescData = protoimpl.X.CompressGZIP(file_modules_claim_v1_initial_claim_proto_rawDescData)
	})
...
func init() { file_modules_claim_v1_initial_claim_proto_init() }
func file_modules_claim_v1_initial_claim_proto_init() {
	if File_modules_claim_v1_initial_claim_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_modules_claim_v1_initial_claim_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_modules_claim_v1_initial_claim_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_modules_claim_v1_initial_claim_proto_goTypes,
		DependencyIndexes: file_modules_claim_v1_initial_claim_proto_depIdxs,
		MessageInfos:      file_modules_claim_v1_initial_claim_proto_msgTypes,
	}.Build()
	File_modules_claim_v1_initial_claim_proto = out.File
	file_modules_claim_v1_initial_claim_proto_rawDesc = nil
	file_modules_claim_v1_initial_claim_proto_goTypes = nil
	file_modules_claim_v1_initial_claim_proto_depIdxs = nil
}
