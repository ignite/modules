...
const (
	Query_Params_FullMethodName           = "/modules.mint.v1.Query/Params"
	Query_Inflation_FullMethodName        = "/modules.mint.v1.Query/Inflation"
	Query_AnnualProvisions_FullMethodName = "/modules.mint.v1.Query/AnnualProvisions"
)
