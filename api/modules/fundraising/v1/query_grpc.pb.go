...
const (
	Query_Params_FullMethodName            = "/modules.fundraising.v1.Query/Params"
	Query_ListAuction_FullMethodName       = "/modules.fundraising.v1.Query/ListAuction"
	Query_GetAuction_FullMethodName        = "/modules.fundraising.v1.Query/GetAuction"
	Query_ListAllowedBidder_FullMethodName = "/modules.fundraising.v1.Query/ListAllowedBidder"
	Query_GetAllowedBidder_FullMethodName  = "/modules.fundraising.v1.Query/GetAllowedBidder"
	Query_ListBid_FullMethodName           = "/modules.fundraising.v1.Query/ListBid"
	Query_GetBid_FullMethodName            = "/modules.fundraising.v1.Query/GetBid"
	Query_ListVestingQueue_FullMethodName  = "/modules.fundraising.v1.Query/ListVestingQueue"
)
