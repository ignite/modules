...
var (
	...
	fd_BaseAuction_auctionID             protoreflect.FieldDescriptor
	fd_BaseAuction_type                  protoreflect.FieldDescriptor
	fd_BaseAuction_auctioneer            protoreflect.FieldDescriptor
	fd_BaseAuction_sellingReserveAddress protoreflect.FieldDescriptor
	fd_BaseAuction_payingReserveAddress  protoreflect.FieldDescriptor
	fd_BaseAuction_startPrice            protoreflect.FieldDescriptor
	fd_BaseAuction_sellingCoin           protoreflect.FieldDescriptor
	fd_BaseAuction_payingCoinDenom       protoreflect.FieldDescriptor
	fd_BaseAuction_vestingReserveAddress protoreflect.FieldDescriptor
	fd_BaseAuction_vestingSchedules      protoreflect.FieldDescriptor
	fd_BaseAuction_startTime             protoreflect.FieldDescriptor
	fd_BaseAuction_endTimes              protoreflect.FieldDescriptor
	fd_BaseAuction_status                protoreflect.FieldDescriptor
)

func init() {
	file_modules_fundraising_v1_auction_proto_init()
	md_BaseAuction = File_modules_fundraising_v1_auction_proto.Messages().ByName("BaseAuction")
	fd_BaseAuction_auctionID = md_BaseAuction.Fields().ByName("auctionID")
	fd_BaseAuction_type = md_BaseAuction.Fields().ByName("type")
	fd_BaseAuction_auctioneer = md_BaseAuction.Fields().ByName("auctioneer")
	fd_BaseAuction_sellingReserveAddress = md_BaseAuction.Fields().ByName("sellingReserveAddress")
	fd_BaseAuction_payingReserveAddress = md_BaseAuction.Fields().ByName("payingReserveAddress")
	fd_BaseAuction_startPrice = md_BaseAuction.Fields().ByName("startPrice")
	fd_BaseAuction_sellingCoin = md_BaseAuction.Fields().ByName("sellingCoin")
	fd_BaseAuction_payingCoinDenom = md_BaseAuction.Fields().ByName("payingCoinDenom")
	fd_BaseAuction_vestingReserveAddress = md_BaseAuction.Fields().ByName("vestingReserveAddress")
	fd_BaseAuction_vestingSchedules = md_BaseAuction.Fields().ByName("vestingSchedules")
	fd_BaseAuction_startTime = md_BaseAuction.Fields().ByName("startTime")
	fd_BaseAuction_endTimes = md_BaseAuction.Fields().ByName("endTimes")
...
func (x *BaseAuction) slowProtoReflect() protoreflect.Message {
	mi := &file_modules_fundraising_v1_auction_proto_msgTypes[0]
...
func (x *fastReflection_BaseAuction) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AuctionID != uint64(0) {
		...
		if !f(fd_BaseAuction_auctionID, value) {
			return
		}
	}
	if x.Type_ != 0 {
...
func (x *fastReflection_BaseAuction) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "modules.fundraising.v1.BaseAuction.auctionID":
		return x.AuctionID != uint64(0)
	case "modules.fundraising.v1.BaseAuction.type":
		return x.Type_ != 0
	case "modules.fundraising.v1.BaseAuction.auctioneer":
		return x.Auctioneer != ""
	case "modules.fundraising.v1.BaseAuction.sellingReserveAddress":
		return x.SellingReserveAddress != ""
	case "modules.fundraising.v1.BaseAuction.payingReserveAddress":
		return x.PayingReserveAddress != ""
	case "modules.fundraising.v1.BaseAuction.startPrice":
		return x.StartPrice != ""
	case "modules.fundraising.v1.BaseAuction.sellingCoin":
		return x.SellingCoin != nil
	case "modules.fundraising.v1.BaseAuction.payingCoinDenom":
		return x.PayingCoinDenom != ""
	case "modules.fundraising.v1.BaseAuction.vestingReserveAddress":
		return x.VestingReserveAddress != ""
	case "modules.fundraising.v1.BaseAuction.vestingSchedules":
		return len(x.VestingSchedules) != 0
	case "modules.fundraising.v1.BaseAuction.startTime":
		return x.StartTime != nil
	case "modules.fundraising.v1.BaseAuction.endTimes":
		return len(x.EndTimes) != 0
	case "modules.fundraising.v1.BaseAuction.status":
		return x.Status != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.fundraising.v1.BaseAuction"))
		}
		panic(fmt.Errorf("message modules.fundraising.v1.BaseAuction does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BaseAuction) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message modules.fundraising.v1.BaseAuction does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BaseAuction) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "modules.fundraising.v1.BaseAuction.endTimes":
		...
		return protoreflect.ValueOfList(value)
	case "modules.fundraising.v1.BaseAuction.auctionID":
		panic(fmt.Errorf("field auctionID of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.type":
		panic(fmt.Errorf("field type of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.auctioneer":
		panic(fmt.Errorf("field auctioneer of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.sellingReserveAddress":
		panic(fmt.Errorf("field sellingReserveAddress of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.payingReserveAddress":
		panic(fmt.Errorf("field payingReserveAddress of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.startPrice":
		panic(fmt.Errorf("field startPrice of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.payingCoinDenom":
		panic(fmt.Errorf("field payingCoinDenom of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.vestingReserveAddress":
		panic(fmt.Errorf("field vestingReserveAddress of message modules.fundraising.v1.BaseAuction is not mutable"))
	case "modules.fundraising.v1.BaseAuction.status":
		panic(fmt.Errorf("field status of message modules.fundraising.v1.BaseAuction is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.fundraising.v1.BaseAuction"))
		}
...
func (x *fastReflection_BaseAuction) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in modules.fundraising.v1.BaseAuction", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_FixedPriceAuction_baseAuction          protoreflect.FieldDescriptor
	fd_FixedPriceAuction_remainingSellingCoin protoreflect.FieldDescriptor
)

func init() {
	file_modules_fundraising_v1_auction_proto_init()
	md_FixedPriceAuction = File_modules_fundraising_v1_auction_proto.Messages().ByName("FixedPriceAuction")
	fd_FixedPriceAuction_baseAuction = md_FixedPriceAuction.Fields().ByName("baseAuction")
	fd_FixedPriceAuction_remainingSellingCoin = md_FixedPriceAuction.Fields().ByName("remainingSellingCoin")
}
...
func (x *FixedPriceAuction) slowProtoReflect() protoreflect.Message {
	mi := &file_modules_fundraising_v1_auction_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_FixedPriceAuction) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "modules.fundraising.v1.FixedPriceAuction.baseAuction":
		return x.BaseAuction != nil
	case "modules.fundraising.v1.FixedPriceAuction.remainingSellingCoin":
		return x.RemainingSellingCoin != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.fundraising.v1.FixedPriceAuction"))
		}
		panic(fmt.Errorf("message modules.fundraising.v1.FixedPriceAuction does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_FixedPriceAuction) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message modules.fundraising.v1.FixedPriceAuction does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_FixedPriceAuction) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in modules.fundraising.v1.FixedPriceAuction", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_BatchAuction_baseAuction       protoreflect.FieldDescriptor
	fd_BatchAuction_minBidPrice       protoreflect.FieldDescriptor
	fd_BatchAuction_matchedPrice      protoreflect.FieldDescriptor
	fd_BatchAuction_maxExtendedRound  protoreflect.FieldDescriptor
	fd_BatchAuction_extendedRoundRate protoreflect.FieldDescriptor
)

func init() {
	file_modules_fundraising_v1_auction_proto_init()
	md_BatchAuction = File_modules_fundraising_v1_auction_proto.Messages().ByName("BatchAuction")
	fd_BatchAuction_baseAuction = md_BatchAuction.Fields().ByName("baseAuction")
	fd_BatchAuction_minBidPrice = md_BatchAuction.Fields().ByName("minBidPrice")
	fd_BatchAuction_matchedPrice = md_BatchAuction.Fields().ByName("matchedPrice")
	fd_BatchAuction_maxExtendedRound = md_BatchAuction.Fields().ByName("maxExtendedRound")
	fd_BatchAuction_extendedRoundRate = md_BatchAuction.Fields().ByName("extendedRoundRate")
}
...
func (x *BatchAuction) slowProtoReflect() protoreflect.Message {
	mi := &file_modules_fundraising_v1_auction_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BatchAuction) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "modules.fundraising.v1.BatchAuction.baseAuction":
		return x.BaseAuction != nil
	case "modules.fundraising.v1.BatchAuction.minBidPrice":
		return x.MinBidPrice != ""
	case "modules.fundraising.v1.BatchAuction.matchedPrice":
		return x.MatchedPrice != ""
	case "modules.fundraising.v1.BatchAuction.maxExtendedRound":
		return x.MaxExtendedRound != uint32(0)
	case "modules.fundraising.v1.BatchAuction.extendedRoundRate":
		return x.ExtendedRoundRate != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.fundraising.v1.BatchAuction"))
		}
		panic(fmt.Errorf("message modules.fundraising.v1.BatchAuction does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BatchAuction) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message modules.fundraising.v1.BatchAuction does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BatchAuction) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "modules.fundraising.v1.BatchAuction.baseAuction":
		...
		return protoreflect.ValueOfMessage(x.BaseAuction.ProtoReflect())
	case "modules.fundraising.v1.BatchAuction.minBidPrice":
		panic(fmt.Errorf("field minBidPrice of message modules.fundraising.v1.BatchAuction is not mutable"))
	case "modules.fundraising.v1.BatchAuction.matchedPrice":
		panic(fmt.Errorf("field matchedPrice of message modules.fundraising.v1.BatchAuction is not mutable"))
	case "modules.fundraising.v1.BatchAuction.maxExtendedRound":
		panic(fmt.Errorf("field maxExtendedRound of message modules.fundraising.v1.BatchAuction is not mutable"))
	case "modules.fundraising.v1.BatchAuction.extendedRoundRate":
		panic(fmt.Errorf("field extendedRoundRate of message modules.fundraising.v1.BatchAuction is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.fundraising.v1.BatchAuction"))
		}
...
func (x *fastReflection_BatchAuction) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in modules.fundraising.v1.BatchAuction", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_VestingSchedule_releaseTime protoreflect.FieldDescriptor
	fd_VestingSchedule_weight      protoreflect.FieldDescriptor
)

func init() {
	file_modules_fundraising_v1_auction_proto_init()
	md_VestingSchedule = File_modules_fundraising_v1_auction_proto.Messages().ByName("VestingSchedule")
	fd_VestingSchedule_releaseTime = md_VestingSchedule.Fields().ByName("releaseTime")
...
func (x *VestingSchedule) slowProtoReflect() protoreflect.Message {
	mi := &file_modules_fundraising_v1_auction_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_VestingSchedule) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "modules.fundraising.v1.VestingSchedule.releaseTime":
		return x.ReleaseTime != nil
	case "modules.fundraising.v1.VestingSchedule.weight":
		return x.Weight != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.fundraising.v1.VestingSchedule"))
		}
		panic(fmt.Errorf("message modules.fundraising.v1.VestingSchedule does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_VestingSchedule) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message modules.fundraising.v1.VestingSchedule does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_VestingSchedule) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "modules.fundraising.v1.VestingSchedule.weight":
		panic(fmt.Errorf("field weight of message modules.fundraising.v1.VestingSchedule is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: modules.fundraising.v1.VestingSchedule"))
		}
...
func (x *fastReflection_VestingSchedule) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in modules.fundraising.v1.VestingSchedule", d.FullName()))
	}
	panic("unreachable")
}
...
func (AuctionType) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_fundraising_v1_auction_proto_enumTypes[0].Descriptor()
}

func (AuctionType) Type() protoreflect.EnumType {
	return &file_modules_fundraising_v1_auction_proto_enumTypes[0]
}
...
func (AuctionType) EnumDescriptor() ([]byte, []int) {
	return file_modules_fundraising_v1_auction_proto_rawDescGZIP(), []int{0}
}
...
func (AuctionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_fundraising_v1_auction_proto_enumTypes[1].Descriptor()
}

func (AuctionStatus) Type() protoreflect.EnumType {
	return &file_modules_fundraising_v1_auction_proto_enumTypes[1]
}
...
func (AuctionStatus) EnumDescriptor() ([]byte, []int) {
	return file_modules_fundraising_v1_auction_proto_rawDescGZIP(), []int{1}
}
...
type BaseAuction struct {
	...
	Type_ AuctionType `protobuf:"varint,2,opt,name=type,proto3,enum=modules.fundraising.v1.AuctionType" json:"type,omitempty"`
	...
	SellingCoin *v1beta1.Coin `protobuf:"bytes,7,opt,name=sellingCoin,proto3" json:"sellingCoin,omitempty"`
	...
	VestingSchedules []*VestingSchedule `protobuf:"bytes,10,rep,name=vestingSchedules,proto3" json:"vestingSchedules,omitempty"`
	...
	EndTimes []*timestamppb.Timestamp `protobuf:"bytes,12,rep,name=endTimes,proto3" json:"endTimes,omitempty"`
...
func (x *BaseAuction) GetAuctionID() uint64 {
	if x != nil {
		return x.AuctionID
	}
	return 0
...
type FixedPriceAuction struct {
	...
	BaseAuction *BaseAuction `protobuf:"bytes,1,opt,name=baseAuction,proto3" json:"baseAuction,omitempty"`
	// remainingSellingCoin specifies the remaining amount of selling coin to sell
	RemainingSellingCoin *v1beta1.Coin `protobuf:"bytes,2,opt,name=remainingSellingCoin,proto3" json:"remainingSellingCoin,omitempty"`
}
...
type BatchAuction struct {
	...
	MatchedPrice string `protobuf:"bytes,3,opt,name=matchedPrice,proto3" json:"matchedPrice,omitempty"`
	...
	// another round
	ExtendedRoundRate string `protobuf:"bytes,5,opt,name=extendedRoundRate,proto3" json:"extendedRoundRate,omitempty"`
}
...
func (*BatchAuction) Descriptor() ([]byte, []int) {
	return file_modules_fundraising_v1_auction_proto_rawDescGZIP(), []int{2}
}
...
type VestingSchedule struct {
	...
	ReleaseTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=releaseTime,proto3" json:"releaseTime,omitempty"`
...
func (*VestingSchedule) Descriptor() ([]byte, []int) {
	return file_modules_fundraising_v1_auction_proto_rawDescGZIP(), []int{3}
}
...
var File_modules_fundraising_v1_auction_proto protoreflect.FileDescriptor

var file_modules_fundraising_v1_auction_proto_rawDesc = []byte{
	0x0a, 0x24, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2f, 0x66, 0x75, 0x6e, 0x64, 0x72, 0x61,
	0x69, 0x73, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2e,
	0x66, 0x75, 0x6e, 0x64, 0x72, 0x61, 0x69, 0x73, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x1a, 0x11,
	...
	,
	...
	0x12, 0x32, 0x0a, 0x14, 0x70, 0x61, 0x79, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14,
	0x70, 0x61, 0x79, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x12, 0x51, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74, 0x50, 0x72, 0x69,
	0x63, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde,
	...
	0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x0a, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x82, 0x01, 0x0a, 0x0b, 0x73, 0x65, 0x6c, 0x6c,
	0x69, 0x6e, 0x67, 0x43, 0x6f, 0x69, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	...
	,
	...
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x12, 0x42, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	0x52, 0x09, 0x73, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x40, 0x0a, 0x08, 0x65,
	0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x08, 0xc8, 0xde, 0x1f, 0x00, 0x90,
	0xdf, 0x1f, 0x01, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x12, 0x3d, 0x0a,
	...
	,
	...
	0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x52, 0x14, 0x72, 0x65, 0x6d,
	0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x69,
	0x6e, 0x3a, 0x04, 0x88, 0xa0, 0x1f, 0x00, 0x22, 0x9a, 0x03, 0x0a, 0x0c, 0x42, 0x61, 0x74, 0x63,
	0x68, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4b, 0x0a, 0x0b, 0x62, 0x61, 0x73, 0x65,
	0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e,
	0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2e, 0x66, 0x75, 0x6e, 0x64, 0x72, 0x61, 0x69, 0x73,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x53, 0x0a, 0x0b, 0x6d, 0x69, 0x6e, 0x42, 0x69, 0x64, 0x50,
	...
	0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x0b, 0x6d,
	0x69, 0x6e, 0x42, 0x69, 0x64, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x55, 0x0a, 0x0c, 0x6d, 0x61,
	0x74, 0x63, 0x68, 0x65, 0x64, 0x50, 0x72, 0x69, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	,
}

var (
	file_modules_fundraising_v1_auction_proto_rawDescOnce sync.Once
	file_modules_fundraising_v1_auction_proto_rawDescData = file_modules_fundraising_v1_auction_proto_rawDesc
)

func file_modules_fundraising_v1_auction_proto_rawDescGZIP() []byte {
	file_modules_fundraising_v1_auction_proto_rawDescOnce.Do(func() {
		file_modules_fundraising_v1_auction_proto_rawDescData = protoimpl.X.CompressGZIP(file_modules_fundraising_v1_auction_proto_rawDescData)
	})
...
var file_modules_fundraising_v1_auction_proto_depIdxs = []int32{
	...
	5,  // 2: modules.fundraising.v1.BaseAuction.vestingSchedules:type_name -> modules.fundraising.v1.VestingSchedule
	7,  // 3: modules.fundraising.v1.BaseAuction.startTime:type_name -> google.protobuf.Timestamp
	7,  // 4: modules.fundraising.v1.BaseAuction.endTimes:type_name -> google.protobuf.Timestamp
	1,  // 5: modules.fundraising.v1.BaseAuction.status:type_name -> modules.fundraising.v1.AuctionStatus
	2,  // 6: modules.fundraising.v1.FixedPriceAuction.baseAuction:type_name -> modules.fundraising.v1.BaseAuction
	6,  // 7: modules.fundraising.v1.FixedPriceAuction.remainingSellingCoin:type_name -> cosmos.base.v1beta1.Coin
	2,  // 8: modules.fundraising.v1.BatchAuction.baseAuction:type_name -> modules.fundraising.v1.BaseAuction
	7,  // 9: modules.fundraising.v1.VestingSchedule.releaseTime:type_name -> google.protobuf.Timestamp
...
func init() { file_modules_fundraising_v1_auction_proto_init() }
func file_modules_fundraising_v1_auction_proto_init() {
	if File_modules_fundraising_v1_auction_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_modules_fundraising_v1_auction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_fundraising_v1_auction_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_fundraising_v1_auction_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_modules_fundraising_v1_auction_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_modules_fundraising_v1_auction_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_modules_fundraising_v1_auction_proto_goTypes,
		DependencyIndexes: file_modules_fundraising_v1_auction_proto_depIdxs,
		EnumInfos:         file_modules_fundraising_v1_auction_proto_enumTypes,
		MessageInfos:      file_modules_fundraising_v1_auction_proto_msgTypes,
	}.Build()
	File_modules_fundraising_v1_auction_proto = out.File
	file_modules_fundraising_v1_auction_proto_rawDesc = nil
	file_modules_fundraising_v1_auction_proto_goTypes = nil
	file_modules_fundraising_v1_auction_proto_depIdxs = nil
}
