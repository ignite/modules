...
var (
	...
	fd_VestingQueue_auctionID   protoreflect.FieldDescriptor
	fd_VestingQueue_auctioneer  protoreflect.FieldDescriptor
	fd_VestingQueue_payingCoin  protoreflect.FieldDescriptor
	fd_VestingQueue_releaseTime protoreflect.FieldDescriptor
...
func init() {
	...
	fd_VestingQueue_auctionID = md_VestingQueue.Fields().ByName("auctionID")
	fd_VestingQueue_auctioneer = md_VestingQueue.Fields().ByName("auctioneer")
	fd_VestingQueue_payingCoin = md_VestingQueue.Fields().ByName("payingCoin")
	fd_VestingQueue_releaseTime = md_VestingQueue.Fields().ByName("releaseTime")
...
func (x *fastReflection_VestingQueue) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AuctionID != uint64(0) {
		...
		if !f(fd_VestingQueue_auctionID, value) {
			return
		}
	}
	if x.Auctioneer != "" {
...
func (x *fastReflection_VestingQueue) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "modules.fundraising.v1.VestingQueue.auctionID":
		return x.AuctionID != uint64(0)
	case "modules.fundraising.v1.VestingQueue.auctioneer":
		return x.Auctioneer != ""
	case "modules.fundraising.v1.VestingQueue.payingCoin":
		return x.PayingCoin != nil
	case "modules.fundraising.v1.VestingQueue.releaseTime":
...
func (x *fastReflection_VestingQueue) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "modules.fundraising.v1.VestingQueue.auctionID":
		panic(fmt.Errorf("field auctionID of message modules.fundraising.v1.VestingQueue is not mutable"))
	case "modules.fundraising.v1.VestingQueue.auctioneer":
...
type VestingQueue struct {
	...
	PayingCoin *v1beta1.Coin `protobuf:"bytes,3,opt,name=payingCoin,proto3" json:"payingCoin,omitempty"`
	// releaseTime specifies the timestamp of the vesting schedule
	ReleaseTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=releaseTime,proto3" json:"releaseTime,omitempty"`
...
var file_modules_fundraising_v1_vesting_queue_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb3, 0x02, 0x0a, 0x0c, 0x56, 0x65,
	0x73, 0x74, 0x69, 0x6e, 0x67, 0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x75,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x61,
	0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x75, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x65, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x75,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x65, 0x72, 0x12, 0x80, 0x01, 0x0a, 0x0a, 0x70, 0x61, 0x79,
	0x69, 0x6e, 0x67, 0x43, 0x6f, 0x69, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	...
	0x0a, 0x70, 0x61, 0x79, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x69, 0x6e, 0x12, 0x46, 0x0a, 0x0b, 0x72,
	0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	0x69, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x64, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x72, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x64, 0x42,
	0xe0, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2e,
	0x66, 0x75, 0x6e, 0x64, 0x72, 0x61, 0x69, 0x73, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x42, 0x11,
	0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x51, 0x75, 0x65, 0x75, 0x65, 0x50, 0x72, 0x6f, 0x74,
...
var (
	file_modules_fundraising_v1_vesting_queue_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
	file_modules_fundraising_v1_vesting_queue_proto_goTypes  = []interface{}{
...
var file_modules_fundraising_v1_vesting_queue_proto_depIdxs = []int32{
	1, // 0: modules.fundraising.v1.VestingQueue.payingCoin:type_name -> cosmos.base.v1beta1.Coin
	2, // 1: modules.fundraising.v1.VestingQueue.releaseTime:type_name -> google.protobuf.Timestamp
